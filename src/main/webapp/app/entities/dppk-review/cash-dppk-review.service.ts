...
export class CashDppkReviewService extends AbstractEntityService<IDppkReview> {
  ...
  queryDelegationApplicationFilterBy(req?: any): Observable<HttpResponse<IDppkReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDppkReview[]>(this.resourceUrl + '/delegation-application/filterBy', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDppkReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDppkReview[]>) => this.preLoadItemArray(res)));
  }
  ...
  public addDelegation(entity: IDppkReview, params?: any): Observable<HttpResponse<DelegationApplicationRequest>> {
    this.preSave(entity);
    const options = createRequestOption(params);
    return this.http
      .post<IDppkReview>(this.resourceUrl + '/delegation-application', entity, { observe: 'response', params: options })
      .pipe(map((res: HttpResponse<IDppkReview>) => this.convertDateFromServer(res)))
      .pipe(map((res: HttpResponse<IDppkReview>) => this.preLoadItem(res)));
  }

  public getMyApplication(idParty: string, idPositionType: string, req?: any): Observable<HttpResponse<IDppkReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDppkReview[]>(this.resourceUrl + '/cash-credit-proposal/my-application/' + idParty + '/position-type/' + idPositionType, {
        params: options,
        observe: 'response',
      })
      .pipe(map((res: HttpResponse<IDppkReview[]>) => this.convertDateArrayFromServer(res)))
  ...
  cashCreditProposalApproval(req?: any): Observable<HttpResponse<IDppkReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDppkReview[]>(this.resourceUrl + '/cash-credit-proposals/cp-status-approval', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDppkReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDppkReview[]>) => this.preLoadItemArray(res)));
  }

  searchCP(req?: any): Observable<HttpResponse<IDppkReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDppkReview[]>(this.resourceUrl + '/_search/cash-credit-proposals', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDppkReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDppkReview[]>) => this.preLoadItemArray(res)));
  }
  ...
  protected isNew(entity: IDppkReview): boolean {
  ...
  protected convertDateArrayFromServer(res: HttpResponse<IDppkReview[]>): HttpResponse<IDppkReview[]> {
    res.body.forEach((creditAgreement: IDppkReview) => {
      //
  ...
  protected preSave(entity: IDppkReview) {
  ...
  public findByCif(cif: string): Observable<HttpResponse<IDppkReview>> {
    return this.http.get<IDppkReview>(this.resourceUrl + '/cif/' + cif, { observe: 'response' });
  }

  public findPersonTemplate(cif: string): Observable<HttpResponse<IDppkReview>> {
    return this.http.get<IDppkReview>(this.resourceUrl + '/cif-person-template/' + cif, { observe: 'response' });
  }

  public findPartyGroupTemplate(cif: string): Observable<HttpResponse<IDppkReview>> {
    return this.http.get<IDppkReview>(this.resourceUrl + '/cif-organization-template/' + cif, { observe: 'response' });
  }
  ...
  public getListRetrive(cif?: string, req?: any): Observable<HttpResponse<any>> {
    ...
    return this.http
      .get<IDppkReview[]>(url, { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDppkReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDppkReview[]>) => this.preLoadItemArray(res)));
  }
