...
@Component({
  ...
  template: `
    ...
    <jhi-mis-dashboard-card title="BY TRANSACTION">
      ...
      <jhi-mis-dashboard-bar-chart [data]="chartData" [date]="dateForm.get('date')?.value" title="Credit Admin"></jhi-mis-dashboard-bar-chart>
    </jhi-mis-dashboard-card>
    ...
    <jhi-mis-dashboard-card title="BY TRANSACTION 2">
      ...
      <jhi-mis-dashboard-bar-chart [data]="chartDummyData" [date]="dateForm2.get('date2')?.value"></jhi-mis-dashboard-bar-chart>
    </jhi-mis-dashboard-card>
