...
@Component({
  ...
  templateUrl: './mis-credit-proposal-timeline-summary.component.html',
  styleUrls: ['./mis-report-credit-proposal-timeline-summary.css', '../mis-report.css', '../disabled-style.scss'],
  styles: [
    `
      .select-all {
        white-space: nowrap;
...
export class MisCreditProposalTimelineSummaryComponent extends AbstractExcelMISReport implements OnInit {
  public lovStatus = [];
  listOfValue = [];
