  ...
  private _addProposalData(worksheet: ExcelJS.Worksheet, proposal, index): void {
    ...
    for (let idx = 0; idx < maxLength; idx++) {
      ...
      worksheet.addRow({
        ...
        totalChangesApp: proposal.totalChangesEqToIDR || '',
        grandTotalDebtorIDRApp: proposal.totalPlafondDebitorIDR || '',
        grandTotalExposureIDRApp: proposal.grandTotalPlafondEqToIDR || '',
