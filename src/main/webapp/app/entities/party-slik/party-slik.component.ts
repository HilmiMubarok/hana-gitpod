...
@Component({
  selector: 'jhi-party-slik',
  templateUrl: './party-slik.component.html',
})
export class PartySlikComponent extends AbstractEntityComponent<IPartySlik> {
