...
@Component({
  selector: 'jhi-party-slik-update',
  templateUrl: './party-slik-update.component.html',
})
export class PartySlikUpdateComponent extends AbstractEntityUpdateComponent<IPartySlik> {
  parties: IParty[] = [];
  partyId: string;
  ...
  constructor(
    ...
    super(dataUtils, partySlikService, elementRef, confirmationService, toastService, activatedRoute);
    this.listChangeEventName = 'partySlikListModification';
  }

  protected initialState(): any {
    return { item: new PartySlik(), tasks: [], id: undefined };
  }
