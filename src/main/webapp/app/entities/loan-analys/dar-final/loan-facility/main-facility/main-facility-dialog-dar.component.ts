...
@Component({
  selector: 'jhi-main-facility-dialog-dar',
  templateUrl: './main-facility-dialog-dar.component.html',
  styleUrls: ['./main-facility-dialog-dar.component.scss'],
})
export class MainFacilityDialogDarComponent implements OnInit {
