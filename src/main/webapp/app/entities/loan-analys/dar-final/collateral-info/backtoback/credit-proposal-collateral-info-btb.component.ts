      ...
      if (this.dynamicCollateral()?.length > 0 && this.creditProposal.products?.length > 0) {
        for (let i = 0; i < this.dynamicCollateral().length; i++) {
          if (
            ...
            this.dynamicCollateral()[i].collateralTypeId !== 'MACHINE' &&
            this.dynamicCollateral()[i].collateralTypeId !== 'REALESTATE' &&
            this.dynamicCollateral()[i].collateralTypeId !== 'VEHICLE' &&
            this.dynamicCollateral()[i].collateralTypeId !== 'PERSONAL_PROPERTY' &&
