...
import { CreditRating, ICreditRating } from 'app/entities/credit-rating/credit-rating.model';
import { ICreditProposal } from 'app/entities/credit-proposal/credit-proposal.model';
import { IPartyCif } from 'app/entities/party-cif/party-cif.model';
import { IListOfValueIndustry } from 'app/entities/credit-proposal/list-of-value-industry.model';
...
@Component({
  ...
  templateUrl: './loan-analys-credit-rating-view.component.html',
  // styleUrls: ['./credit-rating-view.css'],
  styleUrls: ['./credit-rating-view.component.css'],
})
export class LoanAnalysCreditRatingViewComponent extends AbstractEntityBaseViewComponent<ICreditRating> implements OnInit, OnChanges {
  @Input() id: number;
