...
@Component({
  selector: 'jhi-application-product',
  templateUrl: './application-product.component.html',
})
export class ApplicationProductComponent extends AbstractEntityComponent<IApplicationProduct> {
  constructor(
    ...
    this.parentRoute = '/application-product';
  ...
  trackId(index: number, item: IApplicationProduct) {
    return item.id;
  }
  ...
  set applicationProducts(applicationProduct: IApplicationProduct[]) {
    this.items = applicationProduct;
  }
}
