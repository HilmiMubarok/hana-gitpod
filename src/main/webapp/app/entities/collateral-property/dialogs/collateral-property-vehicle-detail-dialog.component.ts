...
@Component({
  selector: 'jhi-collateral-property-vehicle-detail-dialog',
  templateUrl: './collateral-property-vehicle-detail-dialog.component.html',
})
export class CollateralPropertyVehicleDetailDialogComponent {
  public collateralProp: ICollateralProperty;
  constructor(
    private collateralPropertyService: CollateralPropertyService,
    private _dialog: MatDialogRef<CollateralPropertyVehicleDetailDialogComponent>,
