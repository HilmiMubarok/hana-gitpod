...
export class CollateralTypeUpdateComponent extends AbstractEntityUpdateComponent<ICollateralType> {
  ...
  constructor(
    ...
    super(dataUtils, collateralTypeService, elementRef, confirmationService, toastService, activatedRoute);
    this.listChangeEventName = 'collateralTypeListModification';
  }

  protected initialState(): any {
    return { item: new CollateralType(), tasks: [], id: undefined };
  }
