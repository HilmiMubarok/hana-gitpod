...
export class CashLoanOpsReviewService extends AbstractEntityService<ILoanOPSReview> {
  ...
  cashCreditProposalApprovalByStatus(req?: any): Observable<HttpResponse<ILoanOPSReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ILoanOPSReview[]>(this.resourceUrl + '/cash-credit-proposals/by-status', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.preLoadItemArray(res)));
  }
  queryDelegationApplicationFilterBy(req?: any): Observable<HttpResponse<ILoanOPSReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ILoanOPSReview[]>(this.resourceUrl + '/delegation-application/filterBy', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.preLoadItemArray(res)));
  }
  loanOpsReviewBystatus(req?: any): Observable<HttpResponse<ILoanOPSReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ILoanOPSReview[]>(this.resourceUrl + '/cash-credit-proposals/find-by-internal', {
        params: options,
        observe: 'response',
      })
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.convertDateArrayFromServer(res)))
  ...
  public addDelegation(entity: ILoanOPSReview, params?: any): Observable<HttpResponse<DelegationApplicationRequest>> {
    this.preSave(entity);
    const options = createRequestOption(params);
    return this.http
      .post<ILoanOPSReview>(this.resourceUrl + '/delegation-application', entity, { observe: 'response', params: options })
      .pipe(map((res: HttpResponse<ILoanOPSReview>) => this.convertDateFromServer(res)))
      .pipe(map((res: HttpResponse<ILoanOPSReview>) => this.preLoadItem(res)));
  }

  public getMyApplication(idParty: string, idPositionType: string, req?: any): Observable<HttpResponse<ILoanOPSReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ILoanOPSReview[]>(this.resourceUrl + '/cash-credit-proposal/my-application/' + idParty + '/position-type/' + idPositionType, {
        params: options,
        observe: 'response',
      })
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.convertDateArrayFromServer(res)))
  ...
  cashCreditProposalApproval(req?: any): Observable<HttpResponse<ILoanOPSReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ILoanOPSReview[]>(this.resourceUrl + '/cash-credit-proposals/cp-status-approval', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.preLoadItemArray(res)));
  }

  searchCP(req?: any): Observable<HttpResponse<ILoanOPSReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ILoanOPSReview[]>(this.resourceUrl + '/_search/cash-credit-proposals', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.preLoadItemArray(res)));
  }
  ...
  protected isNew(entity: ILoanOPSReview): boolean {
  ...
  protected convertDateArrayFromServer(res: HttpResponse<ILoanOPSReview[]>): HttpResponse<ILoanOPSReview[]> {
    res.body.forEach((creditAgreement: ILoanOPSReview) => {
      //
  ...
  protected preSave(entity: ILoanOPSReview) {
  ...
  public findByCif(cif: string): Observable<HttpResponse<ILoanOPSReview>> {
    return this.http.get<ILoanOPSReview>(this.resourceUrl + '/cif/' + cif, { observe: 'response' });
  }

  public findPersonTemplate(cif: string): Observable<HttpResponse<ILoanOPSReview>> {
    return this.http.get<ILoanOPSReview>(this.resourceUrl + '/cif-person-template/' + cif, { observe: 'response' });
  }

  public findPartyGroupTemplate(cif: string): Observable<HttpResponse<ILoanOPSReview>> {
    return this.http.get<ILoanOPSReview>(this.resourceUrl + '/cif-organization-template/' + cif, { observe: 'response' });
  }
  ...
  public getListRetrive(cif?: string, req?: any): Observable<HttpResponse<any>> {
    ...
    return this.http
      .get<ILoanOPSReview[]>(url, { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ILoanOPSReview[]>) => this.preLoadItemArray(res)));
  }
