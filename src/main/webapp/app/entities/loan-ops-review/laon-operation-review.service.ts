...
export class LoanOpsReviewService extends AbstractEntityService<ILoanOPSReview> {
  ...
  private changgedColRelByCP?: ILoanOPSReview;
  private triggerChanggedColRelByCP = new BehaviorSubject<ILoanOPSReview>(this.changgedColRelByCP);
  public triggerChanggedColRelByCPObservable = this.triggerChanggedColRelByCP.asObservable();

  public changeColRelByCP(newCP: ILoanOPSReview) {
  ...
  public applicationGroubProduct(id: number): Observable<HttpResponse<any>> {
    return this.http
      .get<ILoanOPSReview[]>(MICROSERVICENAME.LOS + '/api/application-group-products/page/' + id, { observe: 'response' })
  ...
  protected convertDateArrayFromServer(res: HttpResponse<ILoanOPSReview[]>): HttpResponse<ILoanOPSReview[]> {
    res.body.forEach((creditProposal: ILoanOPSReview) => {
      //
