...
export class CommEventComponent extends AbstractEntityComponent<ICommEvent> {
  constructor(
  ...
  trackId(index: number, item: ICommEvent) {
    return item.id;
  }
  ...
  set commEvents(commEvent: ICommEvent[]) {
    this.items = commEvent;
  }
}
