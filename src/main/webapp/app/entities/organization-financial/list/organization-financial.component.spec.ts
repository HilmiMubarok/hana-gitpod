...
describe('OrganizationFinancial Management Component', () => {
  let comp: OrganizationFinancialComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'organization-financial', component: OrganizationFinancialComponent }]),
      ...
      .overrideTemplate(OrganizationFinancialComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.organizationFinancials?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
