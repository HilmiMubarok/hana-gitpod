...
export class CashCreditAgreementReviewService extends AbstractEntityService<ICreditAgreementReview> {
  ...
  cashCreditProposalApprovalByStatus(req?: any): Observable<HttpResponse<ICreditAgreementReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ICreditAgreementReview[]>(this.resourceUrl + '/cash-credit-proposals/by-status', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ICreditAgreementReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ICreditAgreementReview[]>) => this.preLoadItemArray(res)));
  }
  queryDelegationApplicationFilterBy(req?: any): Observable<HttpResponse<ICreditAgreementReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ICreditAgreementReview[]>(this.resourceUrl + '/delegation-application/filterBy', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ICreditAgreementReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ICreditAgreementReview[]>) => this.preLoadItemArray(res)));
  }

  creditAgreementBystatus(req?: any): Observable<HttpResponse<ICreditAgreementReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ICreditAgreementReview[]>(this.resourceUrl + '/cash-credit-proposal/review-credit-agreement', {
        params: options,
        observe: 'response',
      })
      .pipe(map((res: HttpResponse<ICreditAgreementReview[]>) => this.convertDateArrayFromServer(res)))
  ...
  public addDelegation(entity: ICreditAgreementReview, params?: any): Observable<HttpResponse<DelegationApplicationRequest>> {
    this.preSave(entity);
    const options = createRequestOption(params);
    return this.http
      .post<ICreditAgreementReview>(this.resourceUrl + '/delegation-application', entity, { observe: 'response', params: options })
      .pipe(map((res: HttpResponse<ICreditAgreementReview>) => this.convertDateFromServer(res)))
      .pipe(map((res: HttpResponse<ICreditAgreementReview>) => this.preLoadItem(res)));
  }

  public getMyApplication(idParty: string, idPositionType: string, req?: any): Observable<HttpResponse<ICreditAgreementReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ICreditAgreementReview[]>(
  ...
  cashCreditProposalApproval(req?: any): Observable<HttpResponse<ICreditAgreementReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ICreditAgreementReview[]>(this.resourceUrl + '/cash-credit-proposals/cp-status-approval', {
        params: options,
        observe: 'response',
      })
      .pipe(map((res: HttpResponse<ICreditAgreementReview[]>) => this.convertDateArrayFromServer(res)))
  ...
  searchCP(req?: any): Observable<HttpResponse<ICreditAgreementReview[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ICreditAgreementReview[]>(this.resourceUrl + '/_search/cash-credit-proposals', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ICreditAgreementReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ICreditAgreementReview[]>) => this.preLoadItemArray(res)));
  }
  ...
  protected isNew(entity: ICreditAgreementReview): boolean {
  ...
  protected convertDateArrayFromServer(res: HttpResponse<ICreditAgreementReview[]>): HttpResponse<ICreditAgreementReview[]> {
    res.body.forEach((creditAgreement: ICreditAgreementReview) => {
      //
  ...
  protected preSave(entity: ICreditAgreementReview) {
  ...
  public findByCif(cif: string): Observable<HttpResponse<ICreditAgreementReview>> {
    return this.http.get<ICreditAgreementReview>(this.resourceUrl + '/cif/' + cif, { observe: 'response' });
  }

  public findPersonTemplate(cif: string): Observable<HttpResponse<ICreditAgreementReview>> {
    return this.http.get<ICreditAgreementReview>(this.resourceUrl + '/cif-person-template/' + cif, { observe: 'response' });
  }

  public findPartyGroupTemplate(cif: string): Observable<HttpResponse<ICreditAgreementReview>> {
    return this.http.get<ICreditAgreementReview>(this.resourceUrl + '/cif-organization-template/' + cif, { observe: 'response' });
  }
  ...
  public getListRetrive(cif?: string, req?: any): Observable<HttpResponse<any>> {
    ...
    return this.http
      .get<ICreditAgreementReview[]>(url, { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ICreditAgreementReview[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ICreditAgreementReview[]>) => this.preLoadItemArray(res)));
  }
