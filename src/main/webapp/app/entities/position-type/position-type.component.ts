...
export class PositionTypeComponent extends AbstractEntityComponent<IPositionType> {
  ...
  constructor(
    ...
    this.parentRoute = '/position-type';
  ...
  trackId(index: number, item: IPositionType) {
    return item.id;
  }
  ...
  set positionTypes(positionType: IPositionType[]) {
    this.items = positionType;
  }
