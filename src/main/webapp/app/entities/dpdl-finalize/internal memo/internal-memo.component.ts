...
import { InternalMemoDetailComponent } from './dialog/dialog-internal-memo-detail.component';
...
export class InternalMemoComponent implements OnChanges {
  ...
  public view(object: object): void {
    ...
    const dialogRef = this.dialog.open(InternalMemoDetailComponent, predicate);
