...
@Component({
  ...
  templateUrl: './document-dpdl-upload-dialog.component.html',
...
export class DocumentDpdlUploadDialogComponent implements OnInit {
  public datas = [];
  public files: File[] = [];
  public file: File;
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<DocumentDpdlUploadDialogComponent>,
