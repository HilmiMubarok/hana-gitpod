...
describe('Cif Management Component', () => {
  let comp: CifComponent;
  let fixture: ComponentFixture<CifComponent>;
  let service: CifService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cif', component: CifComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cifs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
