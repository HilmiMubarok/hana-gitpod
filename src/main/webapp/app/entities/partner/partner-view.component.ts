...
export class PartnerViewComponent extends AbstractEntityBaseViewComponent<IPartner> implements OnChanges {
  @Input() id: number;
  ...
  constructor(
    ...
    super(partnerService, messageService, elementRef, dataUtils, account, eventManager);
