...
import { IndexRateService } from '../../../credit-proposal/index-rate.service';
...
@Component({
  selector: 'jhi-compare-data-loan-facility-dialog',
  templateUrl: './compare-data-loan-facility-dialog.component.html',
...
export class CompareDataLoanFacilityDialogComponent extends AbstractEntityBaseViewComponent<ICreditProposal> implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<CompareDataLoanFacilityDialogComponent>,
    ...
    if (this.rateType === 'FIXED') {
      if (this.ccy !== '') {
        this.indexRateService
          .find('get?&ccy=' + this.ccy + '&rateType=FIXED')
