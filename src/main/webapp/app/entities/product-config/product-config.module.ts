...
import { ProductConfigViewComponent } from './product-config-view.component';

@NgModule({
  imports: [SharedModule, RouterModule.forChild(productConfigRoute)],
  declarations: [ProductConfigComponent, ProductConfigDetailComponent, ProductConfigUpdateComponent, ProductConfigViewComponent],
