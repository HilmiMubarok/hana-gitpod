...
export class CashInsuranceCheckingService extends AbstractEntityService<IInsuranceChecking> {
  ...
  cashCreditProposalApprovalByStatus(req?: any): Observable<HttpResponse<IInsuranceChecking[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IInsuranceChecking[]>(this.resourceUrl + '/cash-credit-proposals/by-status', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IInsuranceChecking[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IInsuranceChecking[]>) => this.preLoadItemArray(res)));
  }
  queryDelegationApplicationFilterBy(req?: any): Observable<HttpResponse<IInsuranceChecking[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IInsuranceChecking[]>(this.resourceUrl + '/delegation-application/filterBy', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IInsuranceChecking[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IInsuranceChecking[]>) => this.preLoadItemArray(res)));
  }

  InsuranceCheckingBystatus(req?: any): Observable<HttpResponse<IInsuranceChecking[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IInsuranceChecking[]>(this.resourceUrl + '/cash-credit-proposals/by-insurance-status', {
        params: options,
        observe: 'response',
      })
      .pipe(map((res: HttpResponse<IInsuranceChecking[]>) => this.convertDateArrayFromServer(res)))
  ...
  public addDelegation(entity: IInsuranceChecking, params?: any): Observable<HttpResponse<DelegationApplicationRequest>> {
    this.preSave(entity);
    const options = createRequestOption(params);
    return this.http
      .post<IInsuranceChecking>(this.resourceUrl + '/delegation-application', entity, { observe: 'response', params: options })
      .pipe(map((res: HttpResponse<IInsuranceChecking>) => this.convertDateFromServer(res)))
      .pipe(map((res: HttpResponse<IInsuranceChecking>) => this.preLoadItem(res)));
  }

  public getMyApplication(idParty: string, idPositionType: string, req?: any): Observable<HttpResponse<IInsuranceChecking[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IInsuranceChecking[]>(
  ...
  cashCreditProposalApproval(req?: any): Observable<HttpResponse<IInsuranceChecking[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IInsuranceChecking[]>(this.resourceUrl + '/cash-credit-proposals/cp-status-approval', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IInsuranceChecking[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IInsuranceChecking[]>) => this.preLoadItemArray(res)));
  }

  searchCP(req?: any): Observable<HttpResponse<IInsuranceChecking[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IInsuranceChecking[]>(this.resourceUrl + '/_search/cash-credit-proposals', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IInsuranceChecking[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IInsuranceChecking[]>) => this.preLoadItemArray(res)));
  }
  ...
  protected isNew(entity: IInsuranceChecking): boolean {
  ...
  protected convertDateArrayFromServer(res: HttpResponse<IInsuranceChecking[]>): HttpResponse<IInsuranceChecking[]> {
    res.body.forEach((creditAgreement: IInsuranceChecking) => {
      //
  ...
  protected preSave(entity: IInsuranceChecking) {
  ...
  public findByCif(cif: string): Observable<HttpResponse<IInsuranceChecking>> {
    return this.http.get<IInsuranceChecking>(this.resourceUrl + '/cif/' + cif, { observe: 'response' });
  }

  public findPersonTemplate(cif: string): Observable<HttpResponse<IInsuranceChecking>> {
    return this.http.get<IInsuranceChecking>(this.resourceUrl + '/cif-person-template/' + cif, { observe: 'response' });
  }

  public findPartyGroupTemplate(cif: string): Observable<HttpResponse<IInsuranceChecking>> {
    return this.http.get<IInsuranceChecking>(this.resourceUrl + '/cif-organization-template/' + cif, { observe: 'response' });
  }
  ...
  public getListRetrive(cif?: string, req?: any): Observable<HttpResponse<any>> {
    ...
    return this.http
      .get<IInsuranceChecking[]>(url, { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IInsuranceChecking[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IInsuranceChecking[]>) => this.preLoadItemArray(res)));
  }
