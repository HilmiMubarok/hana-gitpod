...
export class EmploymentTypeUpdateComponent extends AbstractEntityUpdateComponent<IEmploymentType> {
  constructor(
    ...
    super(dataUtils, employmentTypeService, elementRef, confirmationService, toastService, activatedRoute);
    this.useTask = true;
    this.listChangeEventName = 'employmentTypeListModification';
  }

  protected initialState(): any {
    return { item: new EmploymentType(), tasks: [], id: undefined };
  }
