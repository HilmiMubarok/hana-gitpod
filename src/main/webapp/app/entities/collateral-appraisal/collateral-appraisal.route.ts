...
import { CollateralAppraisalDetailProcessRealEstateComponent } from './collateral-appraisal-process-detail-real-estate.component';
...
export const CollateralAppraisalRoute: Routes = [
  ...
  {
    path: 'real_estate',
    component: CollateralAppraisalDetailProcessRealEstateComponent,
    resolve: {
      content: CollateralAppraisalResolve,
    },
    data: {
