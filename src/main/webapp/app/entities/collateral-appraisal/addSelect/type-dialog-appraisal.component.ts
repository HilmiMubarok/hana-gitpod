...
@Component({
  selector: 'jhi-type-dialog-appraisal',
  templateUrl: './type-dialog-appraisal.component.html',
  providers: [
...
export class TypeDialogAppraisalComponent implements OnInit, OnChanges {
