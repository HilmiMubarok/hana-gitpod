...
import { CollateralAppraisalMaterialWithAppraisalTypeComponent } from './collateral-appraisal-material-with-appraisal-type.component';
...
export const CollateralAppraisalRoute: Routes = [
  {
    path: '',
    component: CollateralAppraisalMaterialWithAppraisalTypeComponent,
    resolve: {
