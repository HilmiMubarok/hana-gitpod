...
import { CollateralAppraisalWithAppraisalTypeRoute } from './collateral-appraisal-with-appraisal-type.route';
...
@NgModule({
  imports: [SharedModule, SharedLibsModule, SharedEntityModule, RouterModule.forChild(CollateralAppraisalWithAppraisalTypeRoute)],
  declarations: [
