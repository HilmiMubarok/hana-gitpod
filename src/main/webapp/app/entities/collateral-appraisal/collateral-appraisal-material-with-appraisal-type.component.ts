...
@Component({
  ...
  templateUrl: './collateral-appraisal-material-with-appraisal-type.component.html',
...
export class CollateralAppraisalMaterialWithAppraisalTypeComponent extends AbstractEntityMaterialComponent<ISurveyAppraisals> implements OnInit {
