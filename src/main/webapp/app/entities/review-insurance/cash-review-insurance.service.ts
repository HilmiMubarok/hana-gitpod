...
export class CashReviewInsuranceService extends AbstractEntityService<IReviewInsurance> {
  ...
  cashCreditProposalApprovalByStatus(req?: any): Observable<HttpResponse<IReviewInsurance[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IReviewInsurance[]>(this.resourceUrl + '/cash-credit-proposals/by-status', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IReviewInsurance[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IReviewInsurance[]>) => this.preLoadItemArray(res)));
  }
  queryDelegationApplicationFilterBy(req?: any): Observable<HttpResponse<IReviewInsurance[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IReviewInsurance[]>(this.resourceUrl + '/delegation-application/filterBy', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IReviewInsurance[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IReviewInsurance[]>) => this.preLoadItemArray(res)));
  }
  ...
  public addDelegation(entity: IReviewInsurance, params?: any): Observable<HttpResponse<DelegationApplicationRequest>> {
    this.preSave(entity);
    const options = createRequestOption(params);
    return this.http
      .post<IReviewInsurance>(this.resourceUrl + '/delegation-application', entity, { observe: 'response', params: options })
      .pipe(map((res: HttpResponse<IReviewInsurance>) => this.convertDateFromServer(res)))
      .pipe(map((res: HttpResponse<IReviewInsurance>) => this.preLoadItem(res)));
  }

  public getMyApplication(idParty: string, idPositionType: string, req?: any): Observable<HttpResponse<IReviewInsurance[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IReviewInsurance[]>(this.resourceUrl + '/cash-credit-proposal/my-application/' + idParty + '/position-type/' + idPositionType, {
        params: options,
        observe: 'response',
      })
      .pipe(map((res: HttpResponse<IReviewInsurance[]>) => this.convertDateArrayFromServer(res)))
  ...
  cashCreditProposalApproval(req?: any): Observable<HttpResponse<IReviewInsurance[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IReviewInsurance[]>(this.resourceUrl + '/cash-credit-proposals/cp-status-approval', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IReviewInsurance[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IReviewInsurance[]>) => this.preLoadItemArray(res)));
  }

  searchCP(req?: any): Observable<HttpResponse<IReviewInsurance[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IReviewInsurance[]>(this.resourceUrl + '/_search/cash-credit-proposals', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IReviewInsurance[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IReviewInsurance[]>) => this.preLoadItemArray(res)));
  }
  ...
  protected isNew(entity: IReviewInsurance): boolean {
  ...
  protected convertDateArrayFromServer(res: HttpResponse<IReviewInsurance[]>): HttpResponse<IReviewInsurance[]> {
    res.body.forEach((creditAgreement: IReviewInsurance) => {
      //
  ...
  protected preSave(entity: IReviewInsurance) {
  ...
  public findByCif(cif: string): Observable<HttpResponse<IReviewInsurance>> {
    return this.http.get<IReviewInsurance>(this.resourceUrl + '/cif/' + cif, { observe: 'response' });
  }

  public findPersonTemplate(cif: string): Observable<HttpResponse<IReviewInsurance>> {
    return this.http.get<IReviewInsurance>(this.resourceUrl + '/cif-person-template/' + cif, { observe: 'response' });
  }

  public findPartyGroupTemplate(cif: string): Observable<HttpResponse<IReviewInsurance>> {
    return this.http.get<IReviewInsurance>(this.resourceUrl + '/cif-organization-template/' + cif, { observe: 'response' });
  }
  ...
  public getListRetrive(cif?: string, req?: any): Observable<HttpResponse<any>> {
    ...
    return this.http
      .get<IReviewInsurance[]>(url, { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IReviewInsurance[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IReviewInsurance[]>) => this.preLoadItemArray(res)));
  }
