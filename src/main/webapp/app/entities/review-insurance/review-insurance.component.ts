...
export class ReviewInsuranceComponent extends AbstractEntityMaterialComponent<IReviewInsurance> implements OnInit {
  ...
  constructor(
    ...
    private cashReviewInsuranceService: CashReviewInsuranceService,
    private templateService: TemplateService
  ) {
    super(_snackBar, reviewInsuranceService);
    this.page = 0;
  ...
  public doSearch(): void {
    ...
    this.cashReviewInsuranceService
      ...
      .subscribe({
        next: (res: HttpResponse<IReviewInsurance[]>) => {
