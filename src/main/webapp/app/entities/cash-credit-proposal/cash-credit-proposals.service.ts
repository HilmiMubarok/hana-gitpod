...
export class CashCreditProposalsService extends AbstractEntityService<ICreditProposal> {
  public resourceUrl: string; // make resourceUrl public
  public partySliks = [];

  constructor(protected http: HttpClient, protected applicationConfigService: ApplicationConfigService) {
    super(http);
    this.resourceUrl = this.applicationConfigService.getEndpointFor(MICROSERVICENAME.LOS + '/api/cash-credit-proposals');
    ...
    this.entityPropertiesResourceUrl = this.applicationConfigService.getEndpointFor(MICROSERVICENAME.LOS + '/api/entity-properties');
  }
