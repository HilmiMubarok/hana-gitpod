...
@NgModule({
  imports: [SharedModule, SharedLibsModule, SharedEntityModule, RouterModule.forChild(darRevisionRoute), CompareDataModule],
  declarations: [
    ...
    // DpdlFinalizeModule,
    DarRevisionComponent,
    DarRevisionViewComponent,
  ],
