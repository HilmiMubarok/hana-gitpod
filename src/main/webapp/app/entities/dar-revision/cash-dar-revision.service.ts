...
export class CashDarRevisionService extends AbstractEntityService<IDarRevisionModel> {
  ...
  cashCreditProposalApprovalByStatus(req?: any): Observable<HttpResponse<IDarRevisionModel[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDarRevisionModel[]>(this.resourceUrl + '/cash-credit-proposals/by-status', { params: options, observe: 'response' })
  ...
  queryDelegationApplicationFilterBy(req?: any): Observable<HttpResponse<IDarRevisionModel[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDarRevisionModel[]>(this.resourceUrl + '/delegation-application/filterBy', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDarRevisionModel[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDarRevisionModel[]>) => this.preLoadItemArray(res)));
  }
  ...
  public addDelegation(entity: IDarRevisionModel, params?: any): Observable<HttpResponse<DelegationApplicationRequest>> {
    this.preSave(entity);
    const options = createRequestOption(params);
    return this.http
      .post<IDarRevisionModel>(this.resourceUrl + '/delegation-application', entity, { observe: 'response', params: options })
      .pipe(map((res: HttpResponse<IDarRevisionModel>) => this.convertDateFromServer(res)))
      .pipe(map((res: HttpResponse<IDarRevisionModel>) => this.preLoadItem(res)));
  }

  public getMyApplication(idParty: string, idPositionType: string, req?: any): Observable<HttpResponse<IDarRevisionModel[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDarRevisionModel[]>(this.resourceUrl + '/cash-credit-proposal/my-application/' + idParty + '/position-type/' + idPositionType, {
        params: options,
        observe: 'response',
      })
      .pipe(map((res: HttpResponse<IDarRevisionModel[]>) => this.convertDateArrayFromServer(res)))
  ...
  cashCreditProposalApproval(req?: any): Observable<HttpResponse<IDarRevisionModel[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDarRevisionModel[]>(this.resourceUrl + '/cash-credit-proposals/cp-status-approval', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDarRevisionModel[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDarRevisionModel[]>) => this.preLoadItemArray(res)));
  }

  searchCP(req?: any): Observable<HttpResponse<IDarRevisionModel[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDarRevisionModel[]>(this.resourceUrl + '/_search/cash-credit-proposals', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDarRevisionModel[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDarRevisionModel[]>) => this.preLoadItemArray(res)));
  }
  ...
  protected convertDateArrayFromServer(res: HttpResponse<IDarRevisionModel[]>): HttpResponse<IDarRevisionModel[]> {
    res.body.forEach((creditProposal: IDarRevisionModel) => {
      //
  ...
  protected preSave(entity: IDarRevisionModel) {
  ...
  public findByCif(cif: string): Observable<HttpResponse<IDarRevisionModel>> {
    return this.http.get<IDarRevisionModel>(this.resourceUrl + '/cif/' + cif, { observe: 'response' });
  }

  public findPersonTemplate(cif: string): Observable<HttpResponse<IDarRevisionModel>> {
    return this.http.get<IDarRevisionModel>(this.resourceUrl + '/cif-person-template/' + cif, { observe: 'response' });
  }

  public findPartyGroupTemplate(cif: string): Observable<HttpResponse<IDarRevisionModel>> {
    return this.http.get<IDarRevisionModel>(this.resourceUrl + '/cif-organization-template/' + cif, { observe: 'response' });
  }
  ...
  public getListRetrive(cif?: string, req?: any): Observable<HttpResponse<any>> {
    ...
    return this.http
      .get<IDarRevisionModel[]>(url, { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDarRevisionModel[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDarRevisionModel[]>) => this.preLoadItemArray(res)));
  }
