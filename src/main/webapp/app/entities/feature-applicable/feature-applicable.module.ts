...
import { FeatureApplicableViewComponent } from './feature-applicable-view.component';

@NgModule({
  imports: [SharedModule, RouterModule.forChild(featureApplicableRoute)],
  declarations: [
    FeatureApplicableComponent,
    FeatureApplicableDetailComponent,
    FeatureApplicableUpdateComponent,
