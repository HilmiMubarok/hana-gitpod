...
@Component({
  selector: 'jhi-binding-value-machine-dialog-loan-ops',
  templateUrl: './binding-value-machine-dialog-loan-ops.component.html',
  styleUrls: ['../binding-value-information-dialog-loan-ops.component.scss'],
})
export class BindingValueMachineDialogLoanOpsComponent implements OnInit {
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<BindingValueMachineDialogLoanOpsComponent>
  ) {
