...
import { BindingValueInformationDialogLoanOpsComponent } from '../binding-value-information-dialog/binding-value-information-dialog-loan-ops.component';
...
@Component({
  selector: 'jhi-binding-value-information-grid-loan-ops',
  templateUrl: './binding-value-information-grid-loan-ops.component.html',
  styleUrls: ['../../collateral-info-loan-ops.style.scss'],
})
export class BindingValueInformationGridLoanOpsComponent implements OnInit, OnChanges {
  constructor(
  ...
  public openDialog(element) {
    const dialogRef = this.dialog.open(BindingValueInformationDialogLoanOpsComponent, {
      width: '80vw',
      data: {
        item: element,
