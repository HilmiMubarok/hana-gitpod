...
@Component({
  selector: 'jhi-binding-value-real-estate-dialog-loan-ops',
  templateUrl: './binding-value-real-estate-dialog-loan-ops.component.html',
  styleUrls: ['../binding-value-information-dialog-loan-ops.component.scss'],
})
export class BindingValueRealEstateDialogLoanOpsComponent implements OnInit {
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<BindingValueRealEstateDialogLoanOpsComponent>
  ) {
