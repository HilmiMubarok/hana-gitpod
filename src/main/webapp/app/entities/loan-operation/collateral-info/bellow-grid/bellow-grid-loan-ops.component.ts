...
@Component({
  ...
  templateUrl: './bellow-grid-loan-ops.component.html',
  styleUrls: ['../collateral-info-loan-ops.style.scss'],
})
export class BellowGridLoanOpsComponent extends AbstractEntityMaterialComponent<ICollateral> implements OnChanges, OnInit, AfterViewInit {
  ...
  public openDialog(element: ICollateral): void {
    ...
    const dialogRef = this.dialog.open(CollateralInfoDialogLoanOpsComponent, predicate);
