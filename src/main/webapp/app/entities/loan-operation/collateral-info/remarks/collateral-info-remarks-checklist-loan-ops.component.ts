...
@Component({
  selector: 'jhi-collateral-info-remarks-checklist-loan-ops',
  templateUrl: './collateral-info-remarks-checklist-loan-ops.component.html',
  styleUrls: ['../checklist/collateral-info-checklist-loan-ops.css'],
  providers: [SelectionService, EditorService, SfdtExportService],
})
export class CollateralInfoRemarksChecklistLoanOpsComponent implements OnChanges, OnInit, OnDestroy {
  ...
  public triggeredSave(): void {
    ...
    this.baService.setLoading(true);
    const key = 'credit_proposal/remark/collateral-info/checklist';
    const docEditor = this.container?.documentEditor as DocumentEditorComponent;
