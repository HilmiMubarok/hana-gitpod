...
@Component({
  selector: 'jhi-collateral-info-remarks-information-loan-ops',
  templateUrl: './collateral-info-remarks-information-loan-ops.component.html',
  styleUrls: ['../checklist/collateral-info-checklist-loan-ops.css'],
  providers: [SelectionService, EditorService, SfdtExportService],
})
export class CollateralInfoRemarksInformationLoanOpsComponent implements OnInit, OnDestroy, OnChanges {
