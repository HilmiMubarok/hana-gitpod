...
@Component({
  selector: 'jhi-collateral-info-dialog-loan-ops',
  templateUrl: './collateral-info-dialog-loan-ops.component.html',
  styleUrls: ['./collateral-info-dialog-loan-ops.css'],
  providers: [
    ToolbarService,
    HtmlEditorService,
...
export class CollateralInfoDialogLoanOpsComponent implements OnInit {
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<CollateralInfoDialogLoanOpsComponent>,
