...
@Component({
  selector: 'jhi-collateral-summary-dialog-loan-ops',
  templateUrl: './collateral-summary-dialog-loan-ops.component.html',
  styleUrls: ['./collateral-summary-dialog-loan-ops.css'],
  providers: [
    ToolbarService,
    HtmlEditorService,
...
export class CollateralSummaryDialogLoanOpsComponent implements OnInit {
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<CollateralSummaryDialogLoanOpsComponent>,
