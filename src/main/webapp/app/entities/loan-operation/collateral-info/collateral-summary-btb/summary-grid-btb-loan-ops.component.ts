...
import { CollateralSummaryDialogLoanOpsComponent } from '../collateral-summary/collateral-summary-dialog-loan-ops.component';
import {
...
@Component({
  ...
  templateUrl: './summary-grid-btb-loan-ops.component.html',
  styleUrls: ['../collateral-info-loan-ops.style.scss'],
})
export class SummaryGridBtbLoanOpsComponent
  ...
  implements OnChanges, OnInit, AfterViewInit
{
  ...
  public openDialog(element: ICollateral): void {
    ...
    const dialogRef = this.dialog.open(CollateralSummaryDialogLoanOpsComponent, predicate);
