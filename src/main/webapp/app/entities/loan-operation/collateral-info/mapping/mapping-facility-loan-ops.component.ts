...
@Component({
  selector: 'jhi-mapping-facility-loan-ops',
  templateUrl: './mapping-facility-loan-ops.component.html',
  styleUrls: ['./mapping-facility-loan-ops.style.css'],
})
export class MappingFacilityLoanOpsComponent implements OnInit, OnChanges {
