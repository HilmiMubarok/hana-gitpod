...
@Component({
  selector: 'jhi-dialog-collateral-info-btb-loan-ops',
  templateUrl: './dialog-collateral-info-btb-loan-ops.component.html',
...
export class DialogCollateralInfoDialogBTBComponent implements OnInit {
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<DialogCollateralInfoDialogBTBComponent>,
