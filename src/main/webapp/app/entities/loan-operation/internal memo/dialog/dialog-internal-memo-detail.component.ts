...
@Component({
  selector: 'jhi-internal-memo-detail-loan-operation',
  templateUrl: './dialog-internal-memo-detail-loan-operation.component.html',
  styleUrls: ['./dialog.scss'],
})
export class InternalMemoDetailLoanOperationComponent implements OnInit {
