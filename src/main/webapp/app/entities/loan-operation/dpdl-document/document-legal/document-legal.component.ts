...
import { DocumentLegalDialogLoanOperationComponent } from './document-legal-dialog.component';
import { DocumentLegalDetailDialogLoanOperationComponent } from './document-legal-detail-dialog.component';

@Component({
  selector: 'jhi-document-legal-loan-operation',
  templateUrl: './document-legal-loan-operation.component.html',
  styleUrls: ['../document.scss'],
})
export class DocumentLegalLoanOperationComponent implements OnChanges {
  ...
  public openDialog(): void {
    ...
    const dialogRef = this.dialog.open(DocumentLegalDialogLoanOperationComponent, predicate);
  ...
  public view(object: object): void {
    ...
    const dialogRef = this.dialog.open(DocumentLegalDetailDialogLoanOperationComponent, predicate);
