...
@Component({
  selector: 'jhi-document-legal-dialog-loan-operation',
  templateUrl: './document-legal-dialog-loan-operation.html',
...
export class DocumentLegalDialogLoanOperationComponent implements OnInit {
  public datas = [];
  public files: File[] = [];
  public file: File;
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<DocumentLegalDialogLoanOperationComponent>,
