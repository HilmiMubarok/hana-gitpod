...
@Component({
  selector: 'jhi-loan-operation-document-legal-detail-dialog-loan-operation',
  templateUrl: './document-legal-detail-dialog-loan-operation.component.html',
  styleUrls: ['../document.scss'],
})
export class DocumentLegalDetailDialogLoanOperationComponent implements OnInit {
