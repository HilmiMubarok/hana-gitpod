...
@Component({
  selector: 'jhi-dpdl-preparation-loan-operation',
  templateUrl: './dpdl-preparation-loan-operation.component.html',
...
export class DpdlPreparationLoanOperationComponent implements OnInit {
