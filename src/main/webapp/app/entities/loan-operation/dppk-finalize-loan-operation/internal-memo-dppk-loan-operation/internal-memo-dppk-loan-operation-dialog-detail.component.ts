...
@Component({
  selector: 'jhi-internal-memo-dppk-loan-operation-dialog-detail',
  templateUrl: './internal-memo-dppk-loan-operation-dialog-detail.component.html',
  styleUrls: [
    '../../../dppk-finalize/dppk-preparation/dppk-preparation-internal-memo/dppk-preparation-internal-memo-dialog.component.scss',
  ],
})
export class InternalMemoDppkLoanOperationDialogDetailComponent implements OnInit {
