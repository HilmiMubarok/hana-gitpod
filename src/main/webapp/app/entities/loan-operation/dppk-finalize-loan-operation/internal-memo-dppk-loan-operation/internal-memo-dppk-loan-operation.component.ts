...
import { InternalMemoDppkLoanOperationDialogComponent } from './internal-memo-dppk-loan-operation-dialog.component';
import { InternalMemoDppkLoanOperationDialogDetailComponent } from './internal-memo-dppk-loan-operation-dialog-detail.component';

@Component({
  selector: 'jhi-internal-memo-dppk-loan-operation',
...
export class InternalMemoDppkLoanOperationComponent implements OnChanges {
  ...
  public openDialog(): void {
    ...
    const dialogRef = this.dialog.open(InternalMemoDppkLoanOperationDialogComponent, predicate);
  ...
  public view(object: object): void {
    ...
    const dialogRef = this.dialog.open(InternalMemoDppkLoanOperationDialogDetailComponent, predicate);
