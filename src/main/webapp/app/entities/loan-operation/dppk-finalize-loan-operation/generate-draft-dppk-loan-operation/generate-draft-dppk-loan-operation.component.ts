...
@Component({
  ...
  templateUrl: './generate-draft-dppk-loan-operation.component.html',
  styleUrls: ['../../../dppk-finalize/dppk-preparation/generate-draft-dppk/generate-draft-dppk.component.scss'],
})
export class GenerateDraftDppkLoanOperationComponent implements OnInit, OnChanges {
  @Input('item')
  get item() {
    return this._item;
  }
