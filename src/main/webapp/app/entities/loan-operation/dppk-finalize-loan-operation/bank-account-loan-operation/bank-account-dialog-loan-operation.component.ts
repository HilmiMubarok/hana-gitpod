...
@Component({
  selector: 'jhi-bank-account-dialog-loan-operation',
  templateUrl: './bank-account-dialog-loan-operation.component.html',
  styleUrls: ['./bank-account-dialog-loan-operation.component.scss'],
})
export class BankAccountDialogLoanOperationComponent implements OnInit {
