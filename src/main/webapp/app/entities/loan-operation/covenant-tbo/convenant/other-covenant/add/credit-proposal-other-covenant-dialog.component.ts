...
@Component({
  selector: 'jhi-other-covenant-dialog-loan',
  templateUrl: './credit-proposal-other-covenant-dialog.component.html',
  styleUrls: ['../other-covenant.css'],
})
export class OtherCovenantLoanDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<OtherCovenantLoanDialogComponent>,
