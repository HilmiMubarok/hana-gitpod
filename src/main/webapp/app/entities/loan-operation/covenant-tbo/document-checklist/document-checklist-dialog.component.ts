...
@Component({
  selector: 'jhi-document-checklist-dialog-loan',
...
export class DocumentChecklistDialogLoanComponent {
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<DocumentChecklistDialogLoanComponent>,
