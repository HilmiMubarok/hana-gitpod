...
import { DocumentChecklistDialogLoanComponent } from './document-checklist-dialog.component';
...
@Component({
  selector: 'jhi-document-checklist-loan',
  templateUrl: './credit-proposal-document-checklist.component.html',
  styleUrls: ['./document.scss'],
})
export class DocumentChecklistLoanComponent implements OnInit {
  public files: any[];
  ...
  public openDialog(element: IDocumentType = null, view: string, item: string): void {
    ...
    const dialogRef = this.dialog.open(DocumentChecklistDialogLoanComponent, predicate);
