...
export class CashDarRevisionCheckerService extends AbstractEntityService<IDarRevisionCheckerModel> {
  ...
  cashCreditProposalApprovalByStatus(req?: any): Observable<HttpResponse<IDarRevisionCheckerModel[]>> {
    ...
    return this.http
      .get<IDarRevisionCheckerModel[]>(this.resourceUrl + '/cash-credit-proposals/by-status', { params: options, observe: 'response' })
  ...
  queryDelegationApplicationFilterBy(req?: any): Observable<HttpResponse<IDarRevisionCheckerModel[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDarRevisionCheckerModel[]>(this.resourceUrl + '/delegation-application/filterBy', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDarRevisionCheckerModel[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDarRevisionCheckerModel[]>) => this.preLoadItemArray(res)));
  }
  ...
  public addDelegation(entity: IDarRevisionCheckerModel, params?: any): Observable<HttpResponse<DelegationApplicationRequest>> {
    this.preSave(entity);
    const options = createRequestOption(params);
    return this.http
      .post<IDarRevisionCheckerModel>(this.resourceUrl + '/delegation-application', entity, { observe: 'response', params: options })
      .pipe(map((res: HttpResponse<IDarRevisionCheckerModel>) => this.convertDateFromServer(res)))
      .pipe(map((res: HttpResponse<IDarRevisionCheckerModel>) => this.preLoadItem(res)));
  }

  public getMyApplication(idParty: string, idPositionType: string, req?: any): Observable<HttpResponse<IDarRevisionCheckerModel[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDarRevisionCheckerModel[]>(
  ...
  cashCreditProposalApproval(req?: any): Observable<HttpResponse<IDarRevisionCheckerModel[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDarRevisionCheckerModel[]>(this.resourceUrl + '/cash-credit-proposals/cp-status-approval', {
        params: options,
        observe: 'response',
      })
      .pipe(map((res: HttpResponse<IDarRevisionCheckerModel[]>) => this.convertDateArrayFromServer(res)))
  ...
  searchCP(req?: any): Observable<HttpResponse<IDarRevisionCheckerModel[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDarRevisionCheckerModel[]>(this.resourceUrl + '/_search/cash-credit-proposals', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDarRevisionCheckerModel[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDarRevisionCheckerModel[]>) => this.preLoadItemArray(res)));
  }
