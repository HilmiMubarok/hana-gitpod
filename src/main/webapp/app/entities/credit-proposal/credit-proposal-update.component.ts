...
@Component({
  selector: 'jhi-credit-proposal-update',
  templateUrl: './credit-proposal-update.component.html',
})
export class CreditProposalUpdateComponent extends AbstractEntityUpdateComponent<ICreditProposal> {
  ...
  constructor(
    ...
    super(dataUtils, creditProposalService, elementRef, confirmationService, toastService, activatedRoute);
    this.useTask = true;
    this.listChangeEventName = 'creditProposalListModification';
  }

  protected initialState(): any {
    return { item: new CreditProposal(), tasks: [], id: undefined };
  }
