...
@Component({
  selector: 'jhi-credit-proposal-collateral-summary-dialog',
  templateUrl: './credit-proposal-collateral-summary-dialog.component.html',
  styleUrls: ['./collateral-summary-dialog.css'],
  providers: [
    ToolbarService,
    HtmlEditorService,
...
export class CreditProposalCollateralSummaryDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<CreditProposalCollateralSummaryDialogComponent>,
