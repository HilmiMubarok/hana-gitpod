...
import { DialogCreditProposalCollateralInfoDialogBTBComponent } from 'app/entities/credit-proposal/collateral-info/backtoback/dialog-credit-proposal-collateral-info-btb.component';
...
@Component({
  ...
  templateUrl: './cp-memo-banding-collateral-backtoback.component.html',
  styleUrls: ['../../../collateral-info/collateral-info-cp.style.scss'],
})
export class CPMemoBandingCollateralBacktobackComponent extends AbstractEntityMaterialComponent<ICollateral> implements OnChanges, OnInit {
