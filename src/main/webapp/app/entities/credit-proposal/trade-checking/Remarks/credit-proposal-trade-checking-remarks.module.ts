...
import { RemarskComponent } from './credit-proposal-trade-checking-remarks.component';

@NgModule({
  imports: [SharedModule, SharedEntityModule, DocumentEditorAllModule, DocumentEditorContainerAllModule],
  declarations: [RemarskComponent],
  exports: [RemarskComponent],
  providers: [
    EditorService,
    SelectionService,
    SfdtExportService,
...
export class CreditProposalTradeCheckingRemarksModule {}
