...
@Component({
  selector: 'jhi-above-grid-previous',
  templateUrl: './above-grid-previous.component.html',
  styleUrls: ['../../collateral-info/collateral-info-cp.style.scss'],
})
export class AboveGridPreviousComponent extends AbstractEntityMaterialComponent<ICollateral> implements OnChanges, OnInit {
