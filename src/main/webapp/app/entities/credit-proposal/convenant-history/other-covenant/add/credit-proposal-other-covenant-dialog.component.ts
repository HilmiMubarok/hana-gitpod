...
@Component({
  selector: 'jhi-other-covenant-dialog-history',
  templateUrl: './credit-proposal-other-covenant-dialog.component.html',
  styleUrls: ['../other-covenant.css'],
})
export class CreditProposalOtherCovenantDialogHistoryComponent {
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<CreditProposalOtherCovenantDialogHistoryComponent>
  ) {
