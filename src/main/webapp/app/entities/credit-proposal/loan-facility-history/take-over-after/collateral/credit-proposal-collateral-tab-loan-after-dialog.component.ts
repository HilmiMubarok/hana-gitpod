...
import { CollateralTabLoanAfterHistoryComponent } from './credit-proposal-collateral-tab-loan-after.component';

@Component({
  selector: 'jhi-collateral-tab-loan-after-dialog-history',
  templateUrl: './credit-proposal-collateral-tab-loan-after-dialog.component.html',
  styleUrls: ['./collateral-info-dialog.css'],
  providers: [ToolbarService, HtmlEditorService],
})
export class CollateralTabLoanAfterDialogHistoryComponent {
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<CollateralTabLoanAfterDialogHistoryComponent>,
