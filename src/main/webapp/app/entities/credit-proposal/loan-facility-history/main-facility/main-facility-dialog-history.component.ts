...
@Component({
  selector: 'jhi-main-facility-dialog-history',
  templateUrl: './main-facility-dialog-history.component.html',
  styleUrls: ['./main-facility-dialog-history.component.scss'],
})
export class MainFacilityDialogHistoryComponent implements OnInit {
