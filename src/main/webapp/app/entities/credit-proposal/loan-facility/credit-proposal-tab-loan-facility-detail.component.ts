...
export class CreditProposalTabLoanFacilityDetailComponent implements OnChanges, OnInit, OnDestroy {
  ...
  saveDocx$: Observable<Blob>;
  saveSfdt$: Observable<Blob>;
  docEditor: DocumentEditorComponent;
