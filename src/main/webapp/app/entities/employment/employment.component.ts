...
export class EmploymentComponent extends AbstractEntityComponent<IEmployment> {
  constructor(
  ...
  set employments(employment: IEmployment[]) {
    this.items = employment;
  }
}
