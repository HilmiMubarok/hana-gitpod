...
describe('Employment Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'employment', component: EmploymentComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
