...
describe('Employment routing resolve service', () => {
  ...
  let routingResolveService: EmploymentRoutingResolveService;
  let service: EmploymentService;
  let resultEmployment: IEmployment | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(EmploymentRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new IEmployment if id is not provided', () => {
      // GIVEN
      ...
      expect(resultEmployment).toEqual(new Employment());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Employment })));
      mockActivatedRouteSnapshot.params = { id: 123 };
