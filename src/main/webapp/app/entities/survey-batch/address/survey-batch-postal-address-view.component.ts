...
@Component({
  selector: 'jhi-survey-batch-postal-address-view',
  templateUrl: './survey-batch-postal-address-view.component.html',
  styleUrls: ['./survey-batch-postal-address.css'],
})
export class SurveyBatchPostalAddressViewComponent extends AbstractEntityBaseViewComponent<IPostalAddress> implements OnChanges, OnInit {
  @Input() id: number;
