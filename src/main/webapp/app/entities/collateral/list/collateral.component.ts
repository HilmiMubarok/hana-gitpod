...
export class CollateralComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.collateralService
        ...
        .subscribe({
          next: (res: HttpResponse<ICollateral[]>) => {
  ...
  trackId(_index: number, item: ICollateral): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICollateral[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
