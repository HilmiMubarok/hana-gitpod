...
export class CashCreditAgreementService extends AbstractEntityService<ICreditAgreement> {
  ...
  cashCreditProposalApprovalByStatus(req?: any): Observable<HttpResponse<ICreditAgreement[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ICreditAgreement[]>(this.resourceUrl + '/cash-credit-proposals/by-status', { params: options, observe: 'response' })
  ...
  queryDelegationApplicationFilterBy(req?: any): Observable<HttpResponse<ICreditAgreement[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ICreditAgreement[]>(this.resourceUrl + '/delegation-application/filterBy', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ICreditAgreement[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ICreditAgreement[]>) => this.preLoadItemArray(res)));
  }
  ...
  cashOrganizationManagements(type: string, attributeKey: string, attributeValue: string): Observable<HttpResponse<ICreditAgreement[]>> {
    return this.http
      .get<ICreditAgreement[]>(
        this.resourceUrl + `/cash-organization-managements/${type}/attribute?attributeKey=${attributeKey}&attributeValue=${attributeValue}`,
        { observe: 'response' }
      )
      .pipe(map((res: HttpResponse<ICreditAgreement[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ICreditAgreement[]>) => this.preLoadItemArray(res)));
  ...
  public addDelegation(entity: ICreditAgreement, params?: any): Observable<HttpResponse<DelegationApplicationRequest>> {
    this.preSave(entity);
    const options = createRequestOption(params);
    return this.http
      .post<ICreditAgreement>(this.resourceUrl + '/delegation-application', entity, { observe: 'response', params: options })
      .pipe(map((res: HttpResponse<ICreditAgreement>) => this.convertDateFromServer(res)))
      .pipe(map((res: HttpResponse<ICreditAgreement>) => this.preLoadItem(res)));
  }

  public getMyApplication(idParty: string, idPositionType: string, req?: any): Observable<HttpResponse<ICreditAgreement[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ICreditAgreement[]>(this.resourceUrl + '/cash-credit-proposal/my-application/' + idParty + '/position-type/' + idPositionType, {
        params: options,
        observe: 'response',
      })
      .pipe(map((res: HttpResponse<ICreditAgreement[]>) => this.convertDateArrayFromServer(res)))
  ...
  cashCreditProposalApproval(req?: any): Observable<HttpResponse<ICreditAgreement[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ICreditAgreement[]>(this.resourceUrl + '/cash-credit-proposals/cp-status-approval', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ICreditAgreement[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ICreditAgreement[]>) => this.preLoadItemArray(res)));
  }

  searchCP(req?: any): Observable<HttpResponse<ICreditAgreement[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<ICreditAgreement[]>(this.resourceUrl + '/_search/cash-credit-proposals', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<ICreditAgreement[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<ICreditAgreement[]>) => this.preLoadItemArray(res)));
  }
  ...
  protected convertDateArrayFromServer(res: HttpResponse<ICreditAgreement[]>): HttpResponse<ICreditAgreement[]> {
    res.body.forEach((creditAgreement: ICreditAgreement) => {
      //
