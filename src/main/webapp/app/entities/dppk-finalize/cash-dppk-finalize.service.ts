...
export class CashDppkFinalizeService extends AbstractEntityService<IDppkFinalize> {
  ...
  cashCreditProposalApprovalByStatus(req?: any): Observable<HttpResponse<IDppkFinalize[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDppkFinalize[]>(this.resourceUrl + '/cash-credit-proposals/by-status', { params: options, observe: 'response' })
  ...
  queryDelegationApplicationFilterBy(req?: any): Observable<HttpResponse<IDppkFinalize[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDppkFinalize[]>(this.resourceUrl + '/delegation-application/filterBy', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDppkFinalize[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDppkFinalize[]>) => this.preLoadItemArray(res)));
  }
  ...
  public addDelegation(entity: IDppkFinalize, params?: any): Observable<HttpResponse<DelegationApplicationRequest>> {
    this.preSave(entity);
    const options = createRequestOption(params);
    return this.http
      .post<IDppkFinalize>(this.resourceUrl + '/delegation-application', entity, { observe: 'response', params: options })
      .pipe(map((res: HttpResponse<IDppkFinalize>) => this.convertDateFromServer(res)))
      .pipe(map((res: HttpResponse<IDppkFinalize>) => this.preLoadItem(res)));
  }

  public getMyApplication(idParty: string, idPositionType: string, req?: any): Observable<HttpResponse<IDppkFinalize[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDppkFinalize[]>(this.resourceUrl + '/cash-credit-proposal/my-application/' + idParty + '/position-type/' + idPositionType, {
        params: options,
        observe: 'response',
      })
      .pipe(map((res: HttpResponse<IDppkFinalize[]>) => this.convertDateArrayFromServer(res)))
  ...
  searchCP(req?: any): Observable<HttpResponse<IDppkFinalize[]>> {
    const options = createRequestOption(req);
    return this.http
      .get<IDppkFinalize[]>(this.resourceUrl + '/_search/cash-credit-proposals', { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDppkFinalize[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDppkFinalize[]>) => this.preLoadItemArray(res)));
  }
  ...
  protected isNew(entity: IDppkFinalize): boolean {
  ...
  protected convertDateArrayFromServer(res: HttpResponse<IDppkFinalize[]>): HttpResponse<IDppkFinalize[]> {
    res.body.forEach((creditAgreement: IDppkFinalize) => {
      //
  ...
  protected preSave(entity: IDppkFinalize) {
  ...
  public findByCif(cif: string): Observable<HttpResponse<IDppkFinalize>> {
    return this.http.get<IDppkFinalize>(this.resourceUrl + '/cif/' + cif, { observe: 'response' });
  }

  public findPersonTemplate(cif: string): Observable<HttpResponse<IDppkFinalize>> {
    return this.http.get<IDppkFinalize>(this.resourceUrl + '/cif-person-template/' + cif, { observe: 'response' });
  }

  public findPartyGroupTemplate(cif: string): Observable<HttpResponse<IDppkFinalize>> {
    return this.http.get<IDppkFinalize>(this.resourceUrl + '/cif-organization-template/' + cif, { observe: 'response' });
  }
  ...
  public getListRetrive(cif?: string, req?: any): Observable<HttpResponse<any>> {
    ...
    return this.http
      .get<IDppkFinalize[]>(url, { params: options, observe: 'response' })
      .pipe(map((res: HttpResponse<IDppkFinalize[]>) => this.convertDateArrayFromServer(res)))
      .pipe(map((res: HttpResponse<IDppkFinalize[]>) => this.preLoadItemArray(res)));
  }
