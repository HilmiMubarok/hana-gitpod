...
@Component({
  selector: 'jhi-dppk-preparation-internal-memo-dialog-detail',
  templateUrl: './dppk-preparation-internal-memo-dialog-detail.component.html',
  styleUrls: ['./dppk-preparation-internal-memo-dialog.component.scss'],
})
export class DppkPreparationInternalMemoDialogDetailComponent implements OnInit {
