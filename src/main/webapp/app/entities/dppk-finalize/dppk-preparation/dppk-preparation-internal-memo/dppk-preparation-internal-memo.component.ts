...
import {
  IInternalMemoDocument,
  IInternalMemoMetaData,
  InternalMemoDocumentMetaData,
} from 'app/entities/dpdl-finalize/internal memo/internal-memo.model';
import { StorageService } from 'app/entities/storage/storage.service';
import { MessageService } from 'primeng/api';
import { DppkPreparationInternalMemoDialogComponent } from './dppk-preparation-internal-memo-dialog.component';
import { ConfirmDialogComponent } from 'app/layouts/miscellaneous/confirm-dialog.component';
import lodash from 'lodash';
import { IDocumentNode } from 'app/entities/document-node/document-node.model';
import { DppkPreparationInternalMemoDialogDetailComponent } from './dppk-preparation-internal-memo-dialog-detail.component';

@Component({
  selector: 'jhi-dppk-preparation-internal-memo',
  templateUrl: './dppk-preparation-internal-memo.component.html',
...
export class DppkPreparationInternalMemoComponent implements OnChanges {
  ...
  public openDialog(): void {
    ...
    const dialogRef = this.dialog.open(DppkPreparationInternalMemoDialogComponent, predicate);
  ...
  public view(object: object): void {
    ...
    const dialogRef = this.dialog.open(DppkPreparationInternalMemoDialogDetailComponent, predicate);
  ...
  public save(res: any): Promise<any> {
    return new Promise((resolve, reject) => {
      ...
      for (let i = 0; i < res.files.length; i++) {
        ...
        this.metaData.objectName = `/dppk/${res.creditProposal.id}/internal-memo/${id}/${files}`;
