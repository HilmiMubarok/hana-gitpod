...
@Component({
  selector: 'jhi-dppk-preparation-internal-memo-dialog',
  templateUrl: './dppk-preparation-internal-memo-dialog.component.html',
  styleUrls: ['./dppk-preparation-internal-memo-dialog.component.scss'],
})
export class DppkPreparationInternalMemoDialogComponent implements OnInit {
  public datas = [];
  public files: File[] = [];
  public file: File;
  ...
  constructor(
    ...
    private _dialog: MatDialogRef<DppkPreparationInternalMemoDialogComponent>,
