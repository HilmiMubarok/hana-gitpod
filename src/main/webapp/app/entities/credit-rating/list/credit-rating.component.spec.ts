...
describe('CreditRating Management Component', () => {
  let comp: CreditRatingComponent;
  let fixture: ComponentFixture<CreditRatingComponent>;
  let service: CreditRatingService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'credit-rating', component: CreditRatingComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CreditRatingComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.creditRatings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
