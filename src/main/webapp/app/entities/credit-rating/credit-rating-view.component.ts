...
export class CreditRatingViewComponent extends AbstractEntityBaseViewComponent<ICreditRating> {
  ...
  parse(){
    ...
    this.creditProposalItem.creditRatings[0].idrMioLLL = Number(this.creditProposalItem.creditRatings[0].internalMaxLLL)*Number(this.creditProposalItem.creditRatings[0].equityPosition);;
    return Number(this.creditProposalItem.creditRatings[0].internalMaxLLL)*Number(this.creditProposalItem.creditRatings[0].equityPosition);;
  }
