...
export class CreditRatingComponent extends AbstractEntityComponent<ICreditRating> {
  constructor(
  ...
  trackId(index: number, item: ICreditRating) {
    return item.id;
  }
  ...
  set creditRatings(creditRating: ICreditRating[]) {
    this.items = creditRating;
  }
}
