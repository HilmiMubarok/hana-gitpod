...
import { ITboReviewModel, TboReviewModel } from './tbo-review.model';
import { TboReviewService } from './tbo-review.service';
import { TboReviewComponent } from './tbo-review.component';
import lodash from 'lodash';
import { BankAccountAnalystMessage } from 'app/entities/credit-proposal/bank-account-analyst/bank-account-analyst.model';
import { BasicInformation } from 'app/entities/credit-proposal/basic-information/basic-information.model';
import { ProspectPerson } from 'app/entities/credit-proposal/basic-prospect-person/prospect-person.model';
import { BusinessActivity } from 'app/entities/credit-proposal/busines-activity/busines-activity.model';
import { CollateralInfoChecklist } from 'app/entities/credit-proposal/collateral-info/checklist/collateral-info-checklist.model';
...
import { Covenant } from 'app/entities/credit-proposal/convenant/convenant.constant';
import { CreditManagementInfo } from 'app/entities/credit-proposal/credit-proposal-tab-management-info.model';
import { CreditTabSummary } from 'app/entities/credit-proposal/credit-proposal-tab-summary.model';
import { IndustryLimit } from 'app/entities/credit-proposal/exposure/industry-limit/industry-limit.model';
import { LegalLendingLimit } from 'app/entities/credit-proposal/exposure/legal-lending/legal-lending-limit.model';
...
} from 'app/entities/credit-proposal/financial-statement/financial-statement.constant';
import { RejectReason } from 'app/entities/credit-proposal/forward-to/reject-to.model';
import { Guarantour } from 'app/entities/credit-proposal/guarantour/guarantour.model';
import { PurposePricing } from 'app/entities/credit-proposal/propose-pricing/purpose-pricing.model';
import { RepaymentCapability } from 'app/entities/credit-proposal/repayment-capability/repayment-capability.constant';
import { FinancialState } from 'app/entities/credit-proposal/repayment-spreadsheet/remarks/financial-statement-remarks.model';
import { CpRacBack } from 'app/entities/credit-proposal/risk-criteria/back-to-back/credit-proposal-risk-acceptance-back.model';
import { CpRacBelow } from 'app/entities/credit-proposal/risk-criteria/below/risk-criteria-below.model';
import { RisksAcceptenceCriteria } from 'app/entities/credit-proposal/risk-criteria/risk-criteria.model';
import { TabCustomerProfitability } from 'app/entities/credit-proposal/tab-customer-profitability/tab-customert-profitability.model';
import { CheckRemarks } from 'app/entities/credit-proposal/trade-checking/Remarks/remarks.model';
import { Facility } from 'app/entities/facility/facility.model';
import { DocumentData } from 'app/entities/loan-analys/assign-to/assign.model';
...
export class TboReviewRoute implements Resolve<ITboReviewModel> {
  constructor(private service: TboReviewService, private router: Router) {}

  resolve(route: ActivatedRouteSnapshot): Observable<ITboReviewModel> | Observable<never> {
    const useTemplate = 'PERSON';
    const id = route.params['id'];
    if (id) {
      return this.service.find(id).pipe(
        mergeMap((creditProposal: HttpResponse<ITboReviewModel>) => {
    ...
    if (useTemplate) {
      return this.service.template(useTemplate).pipe(
        map((res: HttpResponse<ITboReviewModel>) => res.body),
        mergeMap(res => {
          if (res) {
            return of(res);
          } else {
    ...
    const newItem = new TboReviewModel();
...
export const tboReviewRoute: Routes = [
  // {
  //   path: 'v2',
  ...
  {
    path: ':id/edit',
    component: TboReviewViewComponent,
    resolve: {
      content: TboReviewRoute,
    },
    canActivate: [UserRouteAccessService],
  },
  // {
