...
describe('OrganizationLegal Management Component', () => {
  let comp: OrganizationLegalComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'organization-legal', component: OrganizationLegalComponent }]),
      ...
      .overrideTemplate(OrganizationLegalComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.organizationLegals?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
