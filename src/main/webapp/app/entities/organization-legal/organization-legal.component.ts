...
export class OrganizationLegalComponent extends AbstractEntityComponent<IOrganizationLegal> {
  constructor(
    ...
    this.parentRoute = '/organization-legal';
  ...
  trackId(index: number, item: IOrganizationLegal) {
    return item.id;
  }

  get organizationLegals() {
    return this.items;
  }

  set organizationLegals(organizationLegal: IOrganizationLegal[]) {
    this.items = organizationLegal;
  }
}
